...
export default function FormServicios({ servicio, url, peticion, enviar }) {
    ...
    const [nombre, setNombre] = useState(servicio.nombre === undefined ? '' : servicio.nombre);
    const [descripcion, setDescripcion] = useState(servicio.descripcion === undefined ? '' : servicio.descripcion)
    const [categoria, setCategoria] = useState(servicio.categoria === undefined ? '' : servicio.categoria)
    const [imagen, setImagen] = useState(servicio.imagen === undefined ? '' : servicio.imagen)
    const [precio, setPrecio] = useState(servicio.precio === undefined ? '' : servicio.precio)
    const [moneda, setMoneda] = useState(servicio.moneda === undefined ? '' : servicio.moneda)
    ...
    return (
        <form
            ...
            onSubmit={e => {
                ...
                peticionPut(url + servicio.id, peticion, {
                    "nombre": nombre,
                    "descripcion": descripcion,
                    "categoria": categoria,
                    "imagen": imagen,
